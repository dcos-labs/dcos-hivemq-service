...
#   - No images defined in anything but resource.json (and hivemqd into the svc.yml)
#
        ...
        for line in lines:
            ...
            if "image:" in line:
                ...
                if not env_var_matcher.match(image_path):
                    print("""Bad image found in {}. It is a direct reference instead of a hivemqd reference: {}
